...
See the private Oracle production deployment guide for DNS, firewall, image architecture, HTTPS, updates, rollback, and backups.
The private daily maintenance routine is documented in
[production maintenance notes](production-maintenance.md).

Project architecture, engineering rules, and accumulated lessons are documented
in [the project guidelines](project-guidelines.md).
